...
public class MyRotate : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (backValue == -1)
        {
            obj.transform.Rotate(Vector3.up * -1 * Time.deltaTime * 100, Space.World);
        }
        else if (backValue == 1)
        {
            obj.transform.Rotate(Vector3.up * Time.deltaTime * 100, Space.World);
        }
        else if (backValue == -2)
        {
            obj.transform.Rotate(Vector3.right * Time.deltaTime * 100, Space.World);
        }
        else if (backValue == 2)
        {
            obj.transform.Rotate(Vector3.right * -1 * Time.deltaTime * 100, Space.World);
        }
